...
import CompleteTodoClient from "./client"
import { BasePage } from "@/lib/effect/runtime"

/**
 * Complete todo page - thin server wrapper that passes URL params to client.
 * Form metadata is fetched client-side via GraphQL.
 */
const CompleteTodoPage = Effect.fn("CompleteTodoPage")(function* ({
  params,
  searchParams,
}: {
...
export default BasePage.build(CompleteTodoPage)

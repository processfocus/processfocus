...
import type { Holiday } from "@pf/business-calendar"
...
/**
 * Live implementation of the PostgreSQL database operations service.
 *
 * This layer provides all database operations for storing organisation structures
 * in PostgreSQL using Drizzle ORM.
 *
 * All operations require TypedPostgresDrizzle and should be called within a transaction.
 * Operations can fail with SqlError from database errors.
 */
export const PostgresDbOperationsLive = Layer.succeed(DbOperations, {
    ...
    Effect.gen(function* () {
      ...
      const result = yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.orgUnit._deleted, false),
          set: {
            name: orgUnit.name,
            orgUnitLevel: orgUnit.orgUnitLevel,
            parentOrgUnitId: parentOrgUnitId ?? null,
    ...
    Effect.gen(function* () {
      ...
      const result = yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.process._deleted, false),
          set: {
            name: process.name,
            purpose: process.purpose,
            orgUnitId,
    ...
    Effect.gen(function* () {
      ...
      const result = yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.role._deleted, false),
          set: {
            name: role.name,
            orgUnitId,
            _deleted: false,
    ...
    Effect.gen(function* () {
      ...
      const result = yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.phase._deleted, false),
          set: {
            name: phase.name,
            processId,
            phaseOrder: phase.order,
    ...
    Effect.gen(function* () {
      ...
      const result = yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.step._deleted, false),
          set: {
            name: step.name,
            purpose: step.purpose,
            processId,
        ...
        for (const rolePath of step.supportingRolePaths) {
          ...
          yield* db
            ...
            .onConflictDoUpdate({
              ...
              targetWhere: eq(schema.stepSupportingRole._deleted, false),
              set: {
                _deleted: false,
                updatedAt: requestTime,
              },
    ...
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.roleResponsibility._deleted, false),
          set: {
            responsibility: responsibility.responsibility,
            responsibilityOrder: responsibility.order,
            _deleted: false,
    ...
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.oauthProvider._deleted, false),
          set: {
            providerConfig: config,
            updatedAt: requestTime,
          },
    ...
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.invitation._deleted, false),
          set: {
            email: normalizedEmail,
            invitationSource: "model",
            invitationPendingEmail: normalizedEmail,
          ...
          // Qualify the column: Postgres rejects bare invitation_status in
          // ON CONFLICT DO UPDATE ... WHERE as ambiguous against the excluded row.
    ...
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.oauthClient._deleted, false),
          set: {
            clientSecretHash: secretHash,
            audience,
            _deleted: false,
  ...
  upsertWeeklySchedule: (schedule, orgUnitId) =>
    Effect.gen(function* () {
      const db = yield* TypedPostgresDrizzle
      const requestTime = yield* getRequestTime()
      // The pg driver treats JavaScript arrays as PostgreSQL arrays unless the
      // JSONB payload is encoded before binding.
      const timeRanges = JSON.stringify(schedule.timeRanges) as unknown as
      ...
      yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.weeklySchedule._deleted, false),
          set: {
            timeRanges,
            _deleted: false,
            updatedAt: requestTime,
    ...
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .values({
          ...
          holidayRule: holiday.rule as Holiday,
          createdAt: requestTime,
          updatedAt: requestTime,
        })
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.holidayInstance._deleted, false),
          set: {
            holidayRule: holiday.rule as Holiday,
            _deleted: false,
            updatedAt: requestTime,
    ...
    Effect.gen(function* () {
      ...
      const result = yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.documentStore._deleted, false),
          set: {
            name: data.name,
            orgUnitId,
            acceptedTypes: data.acceptedTypes ?? null,
    ...
    Effect.gen(function* () {
      ...
      yield* db
        ...
        .onConflictDoUpdate({
          ...
          targetWhere: eq(schema.stepDocumentStore._deleted, false),
          set: {
            _deleted: false,
            updatedAt: requestTime,
          },

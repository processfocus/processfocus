...
/**
 * SQLite implementation of the FileOperations service.
 * Provides file tracking operations using Drizzle ORM against SQLite.
 */
export const SqliteFileOperationsLive = Layer.effect(
  FileOperations,
  Effect.gen(function* () {
